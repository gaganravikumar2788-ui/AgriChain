...
// Read current cached farmers from localStorage
...
async function postFarmerToSyncBridge(farmerRecord) {
  const endpoints = ['/api/farmers', 'http://localhost:5174/api/farmers', 'http://localhost:5173/api/farmers'];
...
// Save or append registered farmer locally and broadcast
...
// Real-time subscription for Bulk Buyer Dashboard
